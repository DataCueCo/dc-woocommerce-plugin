    ...
    public function createAdminPage()
    {
        ...
        <div class="wrap">
          ...
          <div style="margin-top: 10px; padding-top: 20px; border-top: 1px solid #aaa;">
            <a href="https://app.datacue.co" style="display: inline-block; text-decoration:none; background-color: #80ab4b; color: #fff; padding: 0 20px; height: 40px; border-radius: 20px; line-height: 40px; text-align: center;">LOGIN TO MY DATACUE DASHBOARD</a>
            <div style="margin-top: 20px; font-size: 15px;">No account yet? Sign up <a href="https://app.datacue.co/en/sign-up" style="color: #8c5c85; font-weight: 600;">here</a></div>
          </div>
        </div>
        <?php
    }
